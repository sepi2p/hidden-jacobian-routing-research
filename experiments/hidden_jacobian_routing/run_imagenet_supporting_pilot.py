...
def main():
    ...
    ap.add_argument("--imagenet-root", default="data/imagenet/val")
    ap.add_argument("--output-dir", default="analysis_outputs/hidden_jacobian_routing/imagenet_modern_transport_v1")
