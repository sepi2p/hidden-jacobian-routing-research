...
def main():
    ...
    p.add_argument("--output-dir", default="analysis_outputs/hidden_jacobian_routing/decomposition_robustness")
    p.add_argument(
        "--roots",
        default="cifar=analysis_outputs/hidden_jacobian_routing/paper_multi_attack,imagenet=analysis_outputs/hidden_jacobian_routing/imagenet_pgd_square_generalization_resnet18/paper_multi_attack",
    )
