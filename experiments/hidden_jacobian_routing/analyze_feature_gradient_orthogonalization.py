...
def main() -> None:
    ...
    parser.add_argument("--manifest", default="analysis_outputs/hidden_jacobian_routing/random_ga_classifier_trajectories_resnet18_c10_s5/manifest.csv")
    parser.add_argument("--output-dir", default="analysis_outputs/hidden_jacobian_routing/gradient_orthogonalized_flow")
