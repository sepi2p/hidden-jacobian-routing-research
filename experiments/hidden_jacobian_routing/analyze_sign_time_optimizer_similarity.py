...
def main():
    ...
    p.add_argument("--output-dir", type=Path, default=Path("analysis_outputs/hidden_jacobian_routing/jacobian_null_response/sign_time_optimizer_bbb_resnet50_c200_auto"))
    ...
    metadata = {
        "script": "experiments/hidden_jacobian_routing/analyze_sign_time_optimizer_similarity.py",
