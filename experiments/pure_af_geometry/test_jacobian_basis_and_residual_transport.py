...
from experiments.pure_af_geometry.test_mobility_margin_two_stage_selection import (  # noqa: E402
    parse_csv,
    parse_int_csv,
    projection_energy,
    safe_auprc,
...
def main() -> None:
    ...
    p.add_argument("--candidate-csv", type=Path, default=Path("analysis_outputs/pure_af_geometry/jacobian_null_response/mobility_vs_jacobian_gain_bbb_resnet50_d64/candidate_level_jvp.csv"))
    p.add_argument("--output-dir", type=Path, default=Path("analysis_outputs/pure_af_geometry/jacobian_null_response/jacobian_basis_residual_bbb_resnet50"))
    p.add_argument("--dataset-root", default="/home/sepi/projects/data")
