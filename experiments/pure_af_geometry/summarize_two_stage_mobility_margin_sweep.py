...
def main() -> None:
    ...
    p.add_argument(
        "--root",
        default="analysis_outputs/pure_af_geometry/jacobian_null_response",
    )
    p.add_argument(
        "--glob",
    ...
    p.add_argument(
        "--output",
        default="analysis_outputs/pure_af_geometry/jacobian_null_response/two_stage_mobility_margin_sweep_bbb_resnet50_summary.csv",
    )
    args = p.parse_args()
