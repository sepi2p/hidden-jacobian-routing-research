...
from experiments.pure_af_geometry.evaluate_square_learned_correction_policy import (  # noqa: E402
    ce_feature_step,
...
def main():
    ...
    p.add_argument("--output-dir", default="analysis_outputs/pure_af_geometry/square_learned_correction_transfer_pilot")
