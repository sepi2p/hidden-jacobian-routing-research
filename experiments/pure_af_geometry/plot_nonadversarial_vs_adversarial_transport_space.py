...
def main() -> None:
    ...
    ap.add_argument("--input-dir", type=Path, default=Path("analysis_outputs/pure_af_geometry/nonadversarial_optimization_controls_c200_s40"))
    ap.add_argument("--output", type=Path, default=Path("Formatting_Instructions_For_NeurIPS_2026/figures/f4_adv_vs_nonadversarial_transport_space"))
